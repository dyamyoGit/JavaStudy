...
@WebServlet(urlPatterns = "/funding/review/list")
public class FundingReviewListController extends HttpServlet {
...
//				}
		...
		req.getRequestDispatcher("/views/review/fundingReviewList.jsp").forward(req, resp);
	}
}
