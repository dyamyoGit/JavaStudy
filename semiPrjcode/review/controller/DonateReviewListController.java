...
@WebServlet(urlPatterns = "/donate/review/list")
public class DonateReviewListController extends HttpServlet {
...
//				}
		...
		req.getRequestDispatcher("/views/review/donateReviewList.jsp").forward(req, resp);
	}
}
